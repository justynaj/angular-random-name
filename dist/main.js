...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.setName = function () {
        var _this = this;
        this.getNamesJSON().subscribe(function (data) {
            if (data) {
                var idx = Math.floor(Math.random() * Math.floor(data.length));
                _this.randomName = data[idx];
            }
        });
    };
    AppComponent.prototype.getNamesJSON = function () {
